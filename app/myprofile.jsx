...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#407CE2' },
  ...
  statValue: { fontSize: 16, fontWeight: 'bold', marginTop: 5, color: '#223A6A' },
  statLabel: { fontSize: 12, color: '#777', marginTop: 3, textAlign: 'center' },
  contentWrapper: { flex: 1, marginTop: 30, borderTopLeftRadius: 30, borderTopRightRadius: 30, overflow: 'hidden', backgroundColor: '#fff' },
  menuContainer: { backgroundColor: '#fff', borderTopLeftRadius: 35, borderTopRightRadius: 35, paddingHorizontal: 10, paddingVertical: 20 },
  menuItem: { flexDirection: 'row', alignItems: 'center', paddingVertical: 18, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#eee', borderRadius: 10 },
  menuText: { fontSize: 18, color: '#223A6A', flex: 1, marginLeft: 15 },
  iconCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#E0F0FF', alignItems: 'center', justifyContent: 'center', marginRight: 15 },
});
